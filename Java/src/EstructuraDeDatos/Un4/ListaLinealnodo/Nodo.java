...
/** CLASE INSTANCIABLE PARA MANEJAR UN nodo con 2 datos:
 - un string (dato1)
 - un flotante (dato2)
 - y OBIVAMENTE el apuntador que guarda la dirección del siguiente nodo (liga) */
public class Nodo {
    // 3 atributos: los 2 datos y la liga o enlace al siguiente nodo
    private String dato1;
    private float dato2;
    private Nodo liga;  // La liga SIEMPRE será del mismo tipo de la
    ...
    public void setLiga(Nodo nuevaL) {
        liga = nuevaL;
    }
